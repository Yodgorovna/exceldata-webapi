using ExcelData.Domain.Exceptions;
using Newtonsoft.Json;
//using SahrotunShop.Domain.Exceptions;

namespace ExcelData.WebApi.Middlewares;

public class ExceptionHandlerMiddlewares
{
    private readonly RequestDelegate _next;
    public ExceptionHandlerMiddlewares(RequestDelegate next)
    {
        this._next = next;
    }
